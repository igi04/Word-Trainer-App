...
class Options(BaseWindow):
    ...
    def build_interface(self):
        ...
        label = Label(frame, text="Choose the option for your learning", font=("Helvetica", 30, "bold"))
        label.pack()
        ...
        submit_button = Button(frame, command=self.on_start_click,  text="Start Learning", font=("Helvetica", 25))
